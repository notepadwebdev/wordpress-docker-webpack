...
class Walker_Primary_Nav extends Walker_Nav_Menu {
    ...
    if ($depth === 0) {
      $classes = array( 'sub-menu primary-nav__level-2' );
    } elseif ($depth === 1) {
      $classes = array( 'sub-menu primary-nav__level-3' );
    } else {
    ...
    if ($args->walker->has_children) {
      // Expand Icon.
      $item_output .= '<button class="primary-nav__expand" aria-label="'.$title.'">';
      ob_start();
      $item_output .= get_template_part('template-parts/svg/icon', 'arrow-down');
